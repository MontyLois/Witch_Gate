...
namespace WitchGate.Gameplay.Battles.TurnPhases
{
    public class PlayCardAction : ITurnAction
    {
        ...
        public readonly IGameCard gameCard;
        public int Priority { get; set;}

        public PlayCardAction(IGameCard gameCard, BattlePhase battlePhase)
        {
        ...
        {
            var witch = battlePhase.GetBattleWich(gameCard.CardData.WitchDeck);
